 ...
 * processed_input[input_length]=0b10000000
 *		   
*/
startPadding:	
...
/* fillEnd 
 * Copy the length of the processed input expressed as 64 bit big endian 
 * 
*/
fillEnd:
...
/* prdWords
 * OUTPUT:
 * r0=length in words of the processed input (a multiple of 64 bytes - 512 bits)	
*/ 
prdWords:
...
loop_fm:	
			...
			ldr r8, [r6, r7, lsl #W_SHIFT]		/*r8 <- w[i-15]*/			
			...
			/*r8 <- w[i-2]*/			
			sub r7, r5, #2						/*r7= i-2*/
			ldr r8, [r6, r7, lsl #W_SHIFT]		/*r8 <- w[i-2]*/	
			...
			ldr r8, [r6, r7, lsl #W_SHIFT]		/*r8 <- w[i-16]*/
			
			add r9, r9, r8						/*r9=s0+s1+w[i-16]*/
			
			/*r8 <- w[i-7]*/
			sub r7, r5, #7						/*r7= i-7*/
			ldr r8, [r6, r7, lsl #W_SHIFT]		/*r8 <- w[i-7]*/			
			
			add r9, r9, r8						/*r9=s0+s1+w[i-16]+w[i-7]*/
			
			str r9, [r6, r5, lsl #W_SHIFT]		/*w[i]=s0+s1+w[i-16]+w[i-7]*/	

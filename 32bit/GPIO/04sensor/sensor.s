...
@ Trigger the sensor by setting its pin to 1 for at least 10 
        mov     r0, r5
        mov     r1, PIN_OUT
        bl      gpioPinSet
		mov     r0, #12     	@ turn it on for 12 us
        bl      usleep
...
@ Keep reading the output pin, till its status changes
readAgain:
        mov 	r0, r5			 // programming memory

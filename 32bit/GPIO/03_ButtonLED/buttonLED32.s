@ buttonLED32.s
@ Blinks 5 times a LED connected to pin 26 as soon as a button
@ connected to pin 17 is pressed.
...
mmapOK:        
        mov     r5, r0          		@ use r5 for GPIO programming memory address
...
loop:
		...
		bl 		gpioPinRead
		mov 	r6, r0					@ level of the pin
		mov     r0, #ONE_MS    			@ wait 1 ms
        bl      usleep
		cmp 	r6, #1			 		@ r6=1 if the button is pressed
